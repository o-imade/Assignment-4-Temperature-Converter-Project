...
public class TestConversion
{
    ...
    {
        assertEquals(273.15, TemperatureConverter.celsiusToKelvin(0.0), 1e-9);
    }

    @Test
    void celsiusToKelvin_absoluteZero()
    {
        assertEquals(0.0, TemperatureConverter.celsiusToKelvin(-273.15), 1e-9);
    }
    ...
    {
        assertEquals(-1.0, TemperatureConverter.celsiusToKelvin(-274.15), 1e-9);
    }
}
